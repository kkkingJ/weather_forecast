...
public class Utility {
    ...
    /**
     * 将返回的 JSON 数据解析成 Weather 实体类(实时天气)
     */
    public static Weather handleWeatherResponse(String response) {
        try {
            Log.d("----------------------------","responseweather:"+response);
    ...
    /**
     * 将返回的 JSON 数据解析成 Weather 实体类(天气预报)
     */
    public static Forecast handleForecastResponse(String response) {
        try {
            Log.d("----------------------------","responseforecast:"+response);

            Gson mGson = new Gson();
            Forecast forecastGson = mGson.fromJson(response,Forecast.class);
